...
const login = async (req, res) => {
    ...
    if(passwordsMatch){
        ...
        res.cookie('token', token, {httpOnly: true, secure: process.env.ENVIRONMENT === "development" ? false : true, maxAge: 1*60*60*1000, sameSite: process.env.ENVIRONMENT === "development" ? 'Lax': 'None'})
